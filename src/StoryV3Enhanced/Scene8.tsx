        ...
        <AbsoluteFill style={{ opacity }}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <Img
                        src={staticFile("assets/backgrounds/scene8.svg")}
            ...
            <div style={{
                ...
                상자가 열리자, 안에는 반짝이는 보석이 아니라 낡은 편지 한 통이 들어 있었어요. 편지에는 '진정한 보물은 우정과 용기'라고 적혀 있었죠. 지영이가 웃으며 '이거 완전 유튜브 썰 푸는 느낌이네!'라고 말했어요.
            </div>
