...
export const Scene26 = () => {
  ...
  const narrationText = "이것은 26번째 장면입니다. 옛날 옛적에 멋진 모험이 있었어요.";
  ...
  return (
    <AbsoluteFill style={{ opacity: sceneOpacity }}>
      ...
      <div style={{
        ...
        <Img
          src={staticFile("images/scene26-background.svg")}
          onError={(e) => {
            const target = e.target as HTMLImageElement;
            target.onerror = null;
            target.src = staticFile("images/scene26-background.png");
          }}
          style={{
            width: '100%',
            height: '100%',
      ...
      <Img
          src={staticFile("images/scene26-character-0.svg")}
        onError={(e) => {
          const target = e.target as HTMLImageElement;
          target.onerror = null;
          target.src = staticFile("images/scene26-character-0.png");
        }}
        style={{
          position: 'absolute',
          left: 100,
      ...
      {/* 오디오 */}
      <Audio src={staticFile("audio/scene26-narration.mp3")} />
    </AbsoluteFill>
  );
};
