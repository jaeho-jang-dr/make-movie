    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <Img 
                    src={staticFile("images/v2/scene6-bg.svg")}
                    style={{
            ...
            <Img
                src={staticFile("images/v2/scene6-이슬이.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
            ...
            {/* Narration Audio */}
            <Audio src={staticFile("audio/v2/scene6.mp3")} />
            ...
            <div style={{
                ...
                작은 가방 안에는 물 한 병과 사과 한 개, 그리고 소중한 숲 지도가 전부였다. 미약하지만 단단한 준비였다.
            </div>
        </AbsoluteFill>
    );
};