    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <Img 
                    src={staticFile("images/v2/scene9-bg.svg")}
                    style={{
            ...
            <Img
                src={staticFile("images/v2/scene9-이슬이.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
            ...
            {/* Narration Audio */}
            <Audio src={staticFile("audio/v2/scene9.mp3")} />
            ...
            <div style={{
                ...
                떨리는 숨을 한 번 들이마셨다. 이제 정말 시작이다. 미지의 숲이 그녀를 부르고 있었다.
            </div>
        </AbsoluteFill>
    );
};