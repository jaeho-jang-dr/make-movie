    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <Img 
                    src={staticFile("images/v2/scene11-bg.svg")}
                    style={{
            ...
            <Img
                src={staticFile("images/v2/scene11-이슬이.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
            ...
            {/* Narration Audio */}
            <Audio src={staticFile("audio/v2/scene11.mp3")} />
            ...
            <div style={{
                ...
                발밑의 나뭇잎은 바삭거렸고, 머리 위로는 새들의 노랫소리가 끊이지 않았다. 숲의 모든 것이 살아 숨 쉬는 듯했다.
            </div>
        </AbsoluteFill>
    );
};