    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <Img 
                    src={staticFile("images/v2/scene7-bg.svg")}
                    style={{
            ...
            <Img
                src={staticFile("images/v2/scene7-이슬이.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
            ...
            {/* Narration Audio */}
            <Audio src={staticFile("audio/v2/scene7.mp3")} />
            ...
            <div style={{
                ...
                발걸음은 가볍지만 조심스러웠다. 아무도 모르게, 그녀만의 비밀스러운 여정이 시작되었다.
            </div>
        </AbsoluteFill>
    );
};