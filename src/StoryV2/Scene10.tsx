    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <Img 
                    src={staticFile("images/v2/scene10-bg.svg")}
                    style={{
            ...
            <Img
                src={staticFile("images/v2/scene10-이슬이.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
            ...
            {/* Narration Audio */}
            <Audio src={staticFile("audio/v2/scene10.mp3")} />
            ...
            <div style={{
                ...
                숲은 예상보다 훨씬 생생하고 웅장했다. 거대한 나무들, 이끼 낀 바위, 그리고 이름 모를 꽃들이 그녀를 맞이했다.
            </div>
        </AbsoluteFill>
    );
};