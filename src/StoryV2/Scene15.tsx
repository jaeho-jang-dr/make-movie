    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <Img 
                    src={staticFile("images/v2/scene15-bg.svg")}
                    style={{
            ...
            <Img
                src={staticFile("images/v2/scene15-이슬이.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
            ...
            <Img
                src={staticFile("images/v2/scene15-솔방울.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
            ...
            {/* Narration Audio */}
            <Audio src={staticFile("audio/v2/scene15.mp3")} />
            ...
            <div style={{
                ...
                손을 뻗어 솔방울을 잡는 순간, 따뜻한 온기와 함께 솔방울이 흔들렸다. 그리고 작은 목소리가 들려왔다.
            </div>
        </AbsoluteFill>
    );
};