...
export const Scene8 = () => {
    ...
    return (
        <AbsoluteFill style={{ opacity }}>
            ...
            {/* 민수 */}
            <Img
                src={staticFile("assets/characters/민수_앞모습_넘어지기.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
                    left: interpolate(
            ...
            {/* 지영 */}
            <Img
                src={staticFile("assets/characters/지영_앞모습_장난기.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
                    left: interpolate(
            ...
            {/* 깜깜이 */}
            <Img
                src={staticFile("assets/characters/kkamkkam/깜깜이_앞모습_미소.svg")}
                style={{
                    position: 'absolute',
                    bottom: 200,
                    left: interpolate(
            ...
            <div style={{
                ...
                상자가 열리자, 안에는 반짝이는 보석이 아니라 낡은 편지 한 통이 들어 있었어요. 편지에는 '진정한 보물은 우정과 용기'라고 적혀 있었죠.
            </div>
