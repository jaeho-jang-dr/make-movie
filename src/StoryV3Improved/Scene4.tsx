        ...
        <AbsoluteFill style={{ opacity }}>
            ...
            <div style={{ position: 'absolute', width: '100%', height: '100%', overflow: 'hidden' }}>
                <div style={{ transform: `scale(${bgScale}) translateX(${bgX}px)`, width: '100%', height: '100%' }}>
                    <Img
                        src={staticFile("assets/backgrounds/scene4.svg")}
            ...
            {/* 지영 */}
            <Img
                src={staticFile("assets/characters/지영_삼사분면_손전등_들기.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
                    left: interpolate(
            ...
            {/* 손전등 */}
            <Img
                src={staticFile("assets/props/손전등.svg")}
                style={{
                    position: 'absolute',
                    bottom: 200,
                    left: interpolate(
            ...
            {/* 깜깜이 */}
            <Img
                src={staticFile("assets/characters/kkamkkam/깜깜이_옆모습_걷기.svg")}
                style={{
                    position: 'absolute',
                    bottom: 200,
                    left: interpolate(
            ...
            <div style={{
                ...
                깜깜이는 아이들을 깊은 동굴로 안내했어요. 민수는 어둠이 무서워 떨었지만, 지영이는 '걱정 마! 내가 랩스타처럼 빛나는 플래시를 켤게!'라며 장난스럽게 웃었죠.
            </div>
