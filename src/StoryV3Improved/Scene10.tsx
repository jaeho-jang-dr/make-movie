        ...
        <AbsoluteFill style={{ opacity }}>
            ...
            <div style={{ position: 'absolute', width: '100%', height: '100%', overflow: 'hidden' }}>
                <div style={{ transform: `scale(${bgScale}) translateX(${bgX}px)`, width: '100%', height: '100%' }}>
                    <Img
                        src={staticFile("assets/backgrounds/scene10.svg")}
            ...
            {/* 민수 */}
            <Img
                src={staticFile("assets/characters/민수_옆모습_행복.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
                    left: interpolate(
            ...
            {/* 지영 */}
            <Img
                src={staticFile("assets/characters/지영_앞모습_웃음.svg")}
                style={{
                    position: 'absolute',
                    bottom: 100,
                    left: interpolate(
            ...
            <div style={{
                ...
                마을로 돌아온 민수와 지영이는 매일 함께 모험을 꿈꿨어요. 민수는 이제 용기를 내어 새로운 친구들도 사귀기 시작했답니다. 진정한 보물은 바로 곁에 있었어요.
            </div>
